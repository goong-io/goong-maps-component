        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              closeAllLists();
              if (!sessionToken) sessionToken = v4();
...
var GoongComponent = /*#__PURE__*/function () {
  function GoongComponent(options) {
    ...
    this._container = $('<div/>', {
      "id": options.container + "-" + v4(),
      "class": "map-container"
    });

    if (options.leftPane) {
      this._panel = $('<div/>', {
        "id": options.container + "-panel-" + v4(),
  ...
  _proto.init = function init() {
    ...
    if (this._options.enabledSearch) {
      this._searchBox = $('<div/>', {
        "id": this._options.container + "-search-" + v4(),
        "class": "goong-map-search"
      });
      var searchId = this._options.container + "-input-search-" + v4();
...
var Component = /*#__PURE__*/function (_React$Component) {
  ...
  _proto2.render = function render() {
    return /*#__PURE__*/React.createElement("div", _extends({}, this.state, {
      id: this.state.id
    }));
  };
...
export { GoongComponent, Component };
