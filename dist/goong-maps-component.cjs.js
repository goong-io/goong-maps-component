  ...
  _proto.createMarker = function createMarker(markers) {
    ...
    this._map.loadImage(this._options.markerIcon || imageBase64, function (error, image) {
      ...
      _this4._map.addLayer({
        ...
        'paint': {
          'icon-color': _this4._options.markerColor || "#FF0000"
        }
      });
    });
  };
